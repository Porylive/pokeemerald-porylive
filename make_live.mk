...
ifeq ($(MODERN),1)
	OBJ_DIR_PORYLIVE := $(MODERN_OBJ_DIR_NAME_PORYLIVE)
else
...
live: tidylive all live-prep
	...
	python3 tools/porylive/porylive_get_addresses.py $(MAP) $(OBJ_DIR_PORYLIVE)/addresses.lua; \
	echo ""; \
	echo ""; \
	...
	cat $(WATCHMAN_JSON) | watchman -j > /dev/null; \
